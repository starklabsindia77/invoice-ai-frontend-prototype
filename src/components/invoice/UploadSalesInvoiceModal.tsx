...
interface UploadSalesInvoiceModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSuccess: (invoice: Invoice) => void;
}

const UploadSalesInvoiceModal: React.FC<UploadSalesInvoiceModalProps> = ({ 
  open, 
  onOpenChange,
  onSuccess 
}) => {
  ...
  const simulateProcessing = () => {
    ...
    setTimeout(() => {
      // Generate mock sales invoice data
      const mockInvoiceData: Invoice = {
        id: `SINV-${Math.floor(1000 + Math.random() * 9000)}`,
        vendor: file?.name.split('.')[0] || 'Client Company',
        amount: Math.floor(1000 + Math.random() * 9000) + Math.random(),
        ...
        items: [
          { 
            description: 'Product/Service Sale', 
            quantity: 1, 
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a PDF or image file of your sales invoice to automatically extract the information.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          {!uploadComplete && processingStatus === 'idle' && (
            <div className="grid w-full gap-4">
              <div className="flex flex-col gap-2">
                <Label htmlFor="invoice-file">Select Sales Invoice File</Label>
            ...
            <div className="flex flex-col items-center justify-center gap-4 py-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Your sales invoice has been uploaded successfully.
                </p>
              </div>
            </div>
          )}
          ...
          {processingStatus === 'processing' && (
            <div className="flex flex-col items-center justify-center gap-4 py-4">
              ...
              <div className="text-center">
                <h3 className="text-lg font-medium">Processing Sales Invoice</h3>
                <p className="text-sm text-muted-foreground">
          ...
          {processingStatus === 'success' && (
            <div className="flex flex-col items-center justify-center gap-4 py-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Your sales invoice has been processed successfully.
                </p>
              </div>
            </div>
          )}
          ...
          {processingStatus === 'error' && (
            <div className="flex flex-col items-center justify-center gap-4 py-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  We couldn't process your sales invoice. Please try again or upload a different file.
                </p>
              </div>
            </div>
          )}
...
export default UploadSalesInvoiceModal;
