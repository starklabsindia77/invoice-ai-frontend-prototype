...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="h-screen w-64 flex flex-col bg-sidebar fixed">
      ...
      <div className="p-4 border-b border-sidebar-border">
        <div className="text-sm text-sidebar-foreground/70">Workspace</div>
        <div className="font-medium text-sidebar-foreground">{tenant?.name || 'My Workspace'}</div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <nav className="space-y-1">
          ...
          <SidebarItem
            ...
            title="Integrations"
            isActive={location.pathname.includes('/dashboard/integrations')}
          />
          ...
          <SidebarItem
            ...
            title="Subscription"
            isActive={location.pathname.includes('/dashboard/subscription')}
          />
