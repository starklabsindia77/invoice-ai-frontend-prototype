...
const Dashboard: React.FC = () => {
  ...
  const invoiceProgress = subscription
    ? (subscription.usage.invoicesProcessed /
        subscription.usage.invoicesLimit) *
      100
    : 0;

  const storageProgress = subscription
    ? (subscription.usage.storageUsed / subscription.usage.storageLimit) * 100
    : 0;

  const salesInvoices = recentInvoices.filter(
    (invoice) => invoice.category === "sales"
  );
  const expenseInvoices = recentInvoices.filter(
    (invoice) => invoice.category === "expense"
  );
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <Card>
            ...
            <CardContent>
              ...
              <Progress value={invoiceProgress} className="h-2 mt-2" />
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Progress value={storageProgress} className="h-2 mt-2" />
              <p className="text-xs text-muted-foreground mt-2">
          ...
          <div className="md:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Monthly invoicing activity</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your latest sales invoices</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your latest expense invoices</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="overflow-x-auto">
                <table className="w-full">
